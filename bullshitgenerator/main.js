...
window.$ = function (selector) {
  ...
  function 生成文章(){
      ...
      $("#论文").innerHTML = "<div id='output'>" + 排版 + "</div>";

      let output = document.getElementById("论文")
    ...
    // 改变大小 声明变量
    var number = document.getElementById("number");//玩家总人数
    var range = document.getElementById("range");//滑块的值
    var 论文 = document.getElementById("论文");
  }
